...
struct URLUtilitiesTests {
    ...
    struct PrefixHandling {
        ...
        func withSlash() {
            ...
            #expect(URLUtilities.normalizeDocumentationPath("documentation/swiftui/view") == "swiftui/view")
            #expect(URLUtilities.normalizeDocumentationPath("documentation/foundation/url") == "foundation/url")
        }
        ...
        func withoutSlash() {
            ...
            #expect(URLUtilities.normalizeDocumentationPath("documentationswiftui/view") == "swiftui/view")
            #expect(URLUtilities.normalizeDocumentationPath("documentationfoundation/url") == "foundation/url")
        }
        ...
        func mixed() {
            #expect(URLUtilities.normalizeDocumentationPath("/documentation/swift/array") == "swift/array")
            #expect(URLUtilities.normalizeDocumentationPath("  documentation/swiftui/view  ") == "swiftui/view")
            #expect(URLUtilities.normalizeDocumentationPath("\tdocumentationfoundation/url\n") == "foundation/url")
        }
    }
    ...
    struct GenerateURL {
        ...
        func correctURLs() {
            #expect(URLUtilities.generateAppleDocURL("swift/array") == "https://developer.apple.com/documentation/swift/array")
            #expect(URLUtilities.generateAppleDocURL("swiftui/view") == "https://developer.apple.com/documentation/swiftui/view")
            #expect(URLUtilities.generateAppleDocURL("foundation/url") == "https://developer.apple.com/documentation/foundation/url")
        }
    ...
    struct ValidateURL {
        ...
        func validURLs() {
            #expect(URLUtilities.isValidAppleDocURL("https://developer.apple.com/documentation/swift/array") == true)
            #expect(URLUtilities.isValidAppleDocURL("https://developer.apple.com/documentation/swiftui/view") == true)
            #expect(URLUtilities.isValidAppleDocURL("https://developer.apple.com/documentation/foundation/url") == true)
        }
        ...
        func invalidURLs() {
            ...
            #expect(URLUtilities.isValidAppleDocURL("http://developer.apple.com/documentation/swift") == false)
    ...
    struct Workflow {
        ...
        func variousFormats() {
            let testCases: [(input: String, expectedPath: String, expectedURL: String)] = [
                ...
                ("/swift/array", "swift/array", "https://developer.apple.com/documentation/swift/array"),
                ("documentation/swift/array", "swift/array", "https://developer.apple.com/documentation/swift/array"),
                ("/documentation/swift/array", "swift/array", "https://developer.apple.com/documentation/swift/array"),
                ("  swift/array  ", "swift/array", "https://developer.apple.com/documentation/swift/array"),
            ]
        ...
        func specialCharacters() {
            let normalizedPath = URLUtilities.normalizeDocumentationPath("invalid/path/with/special/chars!@#")
            let url = URLUtilities.generateAppleDocURL(normalizedPath)
